...
class ExtensionHostApiImpl {
  ...
  userAttributeSetItem(name) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var errorMessage = _this7.verifyLookerVersion('>=7.15');

      if (errorMessage) {
        return Promise.reject(new Error(errorMessage));
      }

      return _this7.sendAndReceive(_types.ExtensionRequestType.USER_ATTRIBUTE, {
        type: 'set',
        name,
        value
      });
  ...
  saveContextData(context) {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this10.sendAndReceive(_types.ExtensionRequestType.CONTEXT_DATA, {
        type: 'save',
        contextData
      });
  ...
  refreshContextData() {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this11.contextData = yield _this11.sendAndReceive(_types.ExtensionRequestType.CONTEXT_DATA, {
        type: 'refresh'
      });
  ...
  fetchProxy(resource, init, responseBodyType) {
    ...
    return _asyncToGenerator(function* () {
      var errorMessage = _this12.verifyLookerVersion('>=7.9');
  ...
  serverProxy(resource, init, responseBodyType) {
    ...
    return _asyncToGenerator(function* () {
      var errorMessage = _this13.verifyLookerVersion('>=7.11');
  ...
  oauth2Authenticate(authEndpoint, authParameters) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var errorMessage = _this14.verifyLookerVersion('>=7.9');

      if (errorMessage) {
        return Promise.reject(new Error(errorMessage));
      }

      errorMessage = _this14.validateAuthParameters(authParameters);
  ...
  oauth2ExchangeCodeForToken(authEndpoint, authParameters) {
    ...
    return _asyncToGenerator(function* () {
      var errorMessage = _this15.verifyLookerVersion('>=7.11');
  ...
  sendAndReceive(type, payload) {
    ...
    return _asyncToGenerator(function* () {
      if (!_this16._lookerHostData) {
        return Promise.reject(new Error('Looker host connection not established'));
      }

      return _this16.chattyHost.sendAndReceive(_types.ExtensionEvent.EXTENSION_API_REQUEST, {
        type,
        payload
  ...
  validateAuthParameters(authParameters) {
    ...
    if (authParameters.response_type !== 'token' && authParameters.response_type !== 'code') {
