...
export class ExtensionHostApiImpl {
  ...
  userAttributeSetItem(name) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this7.sendAndReceive(ExtensionRequestType.USER_ATTRIBUTE, {
        type: 'set',
        name,
        value
      });
  ...
  saveContextData(context) {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this10.sendAndReceive(ExtensionRequestType.CONTEXT_DATA, {
        type: 'save',
        contextData
      });
  ...
  refreshContextData() {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this11.contextData = yield _this11.sendAndReceive(ExtensionRequestType.CONTEXT_DATA, {
        type: 'refresh'
      });
  ...
  sendAndReceive(type, payload) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this16.chattyHost.sendAndReceive(ExtensionEvent.EXTENSION_API_REQUEST, {
        type,
        payload
