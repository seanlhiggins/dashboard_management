...
export class Looker31SDK extends APIMethods {
  ...
  update_repository_credential(root_project_id, credential_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this214.put("/projects/".concat(root_project_id, "/credential/").concat(credential_id), null, body, options);
    })();
  }
  ...
  delete_repository_credential(root_project_id, credential_id, options) {
    ...
    return _asyncToGenerator(function* () {
      root_project_id = encodeParam(root_project_id);
      credential_id = encodeParam(credential_id);
      return _this215.delete("/projects/".concat(root_project_id, "/credential/").concat(credential_id), null, null, options);
    })();
  }
  ...
  get_all_repository_credentials(root_project_id, options) {
    ...
    return _asyncToGenerator(function* () {
      root_project_id = encodeParam(root_project_id);
      return _this216.get("/projects/".concat(root_project_id, "/credentials"), null, null, options);
    })();
  }
  ...
  create_query_task(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this217.post('/query_tasks', {
        limit: request.limit,
        apply_formatting: request.apply_formatting,
        apply_vis: request.apply_vis,
        cache: request.cache,
  ...
  query_task_multi_results(query_task_ids, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this218.get('/query_tasks/multi_results', {
        query_task_ids
      }, null, options);
    })();
  }
  ...
  query_task(query_task_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this219.get("/query_tasks/".concat(query_task_id), {
        fields
      }, null, options);
    })();
  }
  ...
  query_task_results(query_task_id, options) {
    ...
    return _asyncToGenerator(function* () {
      query_task_id = encodeParam(query_task_id);
      return _this220.get("/query_tasks/".concat(query_task_id, "/results"), null, null, options);
    })();
  }
  ...
  query(query_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this221.get("/queries/".concat(query_id), {
        fields
      }, null, options);
    })();
  }
  ...
  query_for_slug(slug, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this222.get("/queries/slug/".concat(slug), {
        fields
      }, null, options);
    })();
  }
  ...
  run_query(request, options) {
    ...
    return _asyncToGenerator(function* () {
      request.result_format = encodeParam(request.result_format);
      return _this224.get("/queries/".concat(request.query_id, "/run/").concat(request.result_format), {
        limit: request.limit,
        apply_formatting: request.apply_formatting,
        apply_vis: request.apply_vis,
        cache: request.cache,
  ...
  run_inline_query(request, options) {
    ...
    return _asyncToGenerator(function* () {
      request.result_format = encodeParam(request.result_format);
      return _this225.post("/queries/run/".concat(request.result_format), {
        limit: request.limit,
        apply_formatting: request.apply_formatting,
        apply_vis: request.apply_vis,
        cache: request.cache,
  ...
  run_url_encoded_query(model_name, view_name, result_format, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this226.get("/queries/models/".concat(model_name, "/views/").concat(view_name, "/run/").concat(result_format), null, null, options);
    })();
  }
  ...
  merge_query(merge_query_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this227.get("/merge_queries/".concat(merge_query_id), {
        fields
      }, null, options);
    })();
  }
  ...
  create_merge_query(body, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this228.post('/merge_queries', {
        fields
      }, body, options);
    })();
  }
  ...
  all_running_queries(options) {
    ...
    return _asyncToGenerator(function* () {
      return _this229.get('/running_queries', null, null, options);
    })();
  }
  ...
  kill_query(query_task_id, options) {
    ...
    return _asyncToGenerator(function* () {
      query_task_id = encodeParam(query_task_id);
      return _this230.delete("/running_queries/".concat(query_task_id), null, null, options);
    })();
  }
  ...
  sql_query(slug, options) {
    ...
    return _asyncToGenerator(function* () {
      slug = encodeParam(slug);
      return _this231.get("/sql_queries/".concat(slug), null, null, options);
    })();
  }
  ...
  create_sql_query(body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this232.post('/sql_queries', null, body, options);
    })();
  }
  ...
  run_sql_query(slug, result_format, download, options) {
    ...
    return _asyncToGenerator(function* () {
      slug = encodeParam(slug);
      result_format = encodeParam(result_format);
      return _this233.post("/sql_queries/".concat(slug, "/run/").concat(result_format), {
        download
      }, null, options);
    })();
  }
  ...
  create_lookml_dashboard_render_task(request, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      request.result_format = encodeParam(request.result_format);
      return _this234.post("/render_tasks/lookml_dashboards/".concat(request.dashboard_id, "/").concat(request.result_format), {
        width: request.width,
        height: request.height,
        fields: request.fields,
  ...
  create_look_render_task(look_id, result_format, width, height, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      result_format = encodeParam(result_format);
      return _this235.post("/render_tasks/looks/".concat(look_id, "/").concat(result_format), {
        width,
        height,
        fields
      }, null, options);
  ...
  create_query_render_task(query_id, result_format, width, height, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      result_format = encodeParam(result_format);
      return _this236.post("/render_tasks/queries/".concat(query_id, "/").concat(result_format), {
        width,
        height,
        fields
      }, null, options);
  ...
  create_dashboard_render_task(request, options) {
    ...
    return _asyncToGenerator(function* () {
      request.result_format = encodeParam(request.result_format);
      return _this237.post("/render_tasks/dashboards/".concat(request.dashboard_id, "/").concat(request.result_format), {
        width: request.width,
        height: request.height,
        fields: request.fields,
        pdf_paper_size: request.pdf_paper_size,
  ...
  render_task(render_task_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this238.get("/render_tasks/".concat(render_task_id), {
        fields
      }, null, options);
    })();
  }
  ...
  render_task_results(render_task_id, options) {
    ...
    return _asyncToGenerator(function* () {
      render_task_id = encodeParam(render_task_id);
      return _this239.get("/render_tasks/".concat(render_task_id, "/results"), null, null, options);
    })();
  }
  ...
  search_model_sets(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this240.get('/model_sets/search', {
        fields: request.fields,
        limit: request.limit,
        offset: request.offset,
        sorts: request.sorts,
  ...
  model_set(model_set_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this241.get("/model_sets/".concat(model_set_id), {
        fields
      }, null, options);
    })();
  }
  ...
  update_model_set(model_set_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this242.patch("/model_sets/".concat(model_set_id), null, body, options);
    })();
  }
  ...
  delete_model_set(model_set_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this243.delete("/model_sets/".concat(model_set_id), null, null, options);
    })();
  }
  ...
  all_model_sets(fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this244.get('/model_sets', {
        fields
      }, null, options);
    })();
  }
  ...
  create_model_set(body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this245.post('/model_sets', null, body, options);
    })();
  }
  ...
  all_permissions(options) {
    ...
    return _asyncToGenerator(function* () {
      return _this246.get('/permissions', null, null, options);
    })();
  }
  ...
  search_permission_sets(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this247.get('/permission_sets/search', {
        fields: request.fields,
        limit: request.limit,
        offset: request.offset,
        sorts: request.sorts,
  ...
  permission_set(permission_set_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this248.get("/permission_sets/".concat(permission_set_id), {
        fields
      }, null, options);
    })();
  }
  ...
  update_permission_set(permission_set_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this249.patch("/permission_sets/".concat(permission_set_id), null, body, options);
    })();
  }
  ...
  delete_permission_set(permission_set_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this250.delete("/permission_sets/".concat(permission_set_id), null, null, options);
    })();
  }
  ...
  all_permission_sets(fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this251.get('/permission_sets', {
        fields
      }, null, options);
    })();
  }
  ...
  create_permission_set(body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this252.post('/permission_sets', null, body, options);
    })();
  }
  ...
  create_role(body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this254.post('/roles', null, body, options);
    })();
  }
  ...
  search_roles(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this255.get('/roles/search', {
        fields: request.fields,
        limit: request.limit,
        offset: request.offset,
        sorts: request.sorts,
  ...
  role(role_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this256.get("/roles/".concat(role_id), null, null, options);
    })();
  }
  ...
  update_role(role_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this257.patch("/roles/".concat(role_id), null, body, options);
    })();
  }
  ...
  delete_role(role_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this258.delete("/roles/".concat(role_id), null, null, options);
    })();
  }
  ...
  role_groups(role_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this259.get("/roles/".concat(role_id, "/groups"), {
        fields
      }, null, options);
    })();
  }
  ...
  set_role_groups(role_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this260.put("/roles/".concat(role_id, "/groups"), null, body, options);
    })();
  }
  ...
  role_users(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this261.get("/roles/".concat(request.role_id, "/users"), {
        fields: request.fields,
  ...
  set_role_users(role_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this262.put("/roles/".concat(role_id, "/users"), null, body, options);
    })();
  }
  ...
  scheduled_plans_for_space(space_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this263.get("/scheduled_plans/space/".concat(space_id), {
        fields
      }, null, options);
    })();
  }
  ...
  scheduled_plan(scheduled_plan_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this264.get("/scheduled_plans/".concat(scheduled_plan_id), {
        fields
      }, null, options);
    })();
  }
  ...
  update_scheduled_plan(scheduled_plan_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this265.patch("/scheduled_plans/".concat(scheduled_plan_id), null, body, options);
    })();
  }
  ...
  delete_scheduled_plan(scheduled_plan_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this266.delete("/scheduled_plans/".concat(scheduled_plan_id), null, null, options);
    })();
  }
  ...
  all_scheduled_plans(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this267.get('/scheduled_plans', {
        user_id: request.user_id,
        fields: request.fields,
  ...
  create_scheduled_plan(body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this268.post('/scheduled_plans', null, body, options);
    })();
  }
  ...
  scheduled_plan_run_once(body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this269.post('/scheduled_plans/run_once', null, body, options);
    })();
  }
  ...
  scheduled_plans_for_look(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this270.get("/scheduled_plans/look/".concat(request.look_id), {
        user_id: request.user_id,
        fields: request.fields,
        all_users: request.all_users
      }, null, options);
  ...
  scheduled_plans_for_dashboard(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this271.get("/scheduled_plans/dashboard/".concat(request.dashboard_id), {
        user_id: request.user_id,
        all_users: request.all_users,
        fields: request.fields
      }, null, options);
  ...
  scheduled_plans_for_lookml_dashboard(request, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this272.get("/scheduled_plans/lookml_dashboard/".concat(request.lookml_dashboard_id), {
        user_id: request.user_id,
        fields: request.fields,
        all_users: request.all_users
      }, null, options);
  ...
  scheduled_plan_run_once_by_id(scheduled_plan_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this273.post("/scheduled_plans/".concat(scheduled_plan_id, "/run_once"), null, body, options);
    })();
  }
  ...
  session(options) {
    ...
    return _asyncToGenerator(function* () {
      return _this274.get('/session', null, null, options);
    })();
  }
  ...
  update_session(body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this275.patch('/session', null, body, options);
    })();
  }
  ...
  search_spaces(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this276.get('/spaces/search', {
        fields: request.fields,
        page: request.page,
        per_page: request.per_page,
        limit: request.limit,
  ...
  space(space_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      space_id = encodeParam(space_id);
      return _this277.get("/spaces/".concat(space_id), {
        fields
      }, null, options);
    })();
  }
  ...
  update_space(space_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      space_id = encodeParam(space_id);
      return _this278.patch("/spaces/".concat(space_id), null, body, options);
    })();
  }
  ...
  delete_space(space_id, options) {
    ...
    return _asyncToGenerator(function* () {
      space_id = encodeParam(space_id);
      return _this279.delete("/spaces/".concat(space_id), null, null, options);
    })();
  }
  ...
  create_space(body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this281.post('/spaces', null, body, options);
    })();
  }
  ...
  space_children(request, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this282.get("/spaces/".concat(request.space_id, "/children"), {
        fields: request.fields,
        page: request.page,
        per_page: request.per_page,
        sorts: request.sorts
  ...
  space_children_search(request, options) {
    ...
    return _asyncToGenerator(function* () {
      request.space_id = encodeParam(request.space_id);
      return _this283.get("/spaces/".concat(request.space_id, "/children/search"), {
        fields: request.fields,
        sorts: request.sorts,
        name: request.name
      }, null, options);
  ...
  space_parent(space_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      space_id = encodeParam(space_id);
      return _this284.get("/spaces/".concat(space_id, "/parent"), {
        fields
      }, null, options);
    })();
  }
  ...
  space_ancestors(space_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      space_id = encodeParam(space_id);
      return _this285.get("/spaces/".concat(space_id, "/ancestors"), {
        fields
      }, null, options);
    })();
  }
  ...
  space_looks(space_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      space_id = encodeParam(space_id);
      return _this286.get("/spaces/".concat(space_id, "/looks"), {
        fields
      }, null, options);
    })();
  }
  ...
  space_dashboards(space_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      space_id = encodeParam(space_id);
      return _this287.get("/spaces/".concat(space_id, "/dashboards"), {
        fields
      }, null, options);
    })();
  }
  ...
  create_theme(body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this289.post('/themes', null, body, options);
    })();
  }
  ...
  search_themes(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this290.get('/themes/search', {
        id: request.id,
        name: request.name,
  ...
  default_theme(ts, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this291.get('/themes/default', {
        ts
      }, null, options);
    })();
  }
  ...
  set_default_theme(name, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this292.put('/themes/default', {
        name
      }, null, options);
    })();
  }
  ...
  active_themes(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this293.get('/themes/active', {
        name: request.name,
        ts: request.ts,
        fields: request.fields
      }, null, options);
  ...
  theme_or_default(name, ts, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this294.get('/themes/theme_or_default', {
        name,
        ts
      }, null, options);
    })();
  ...
  validate_theme(body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this295.post('/themes/validate', null, body, options);
    })();
  }
  ...
  theme(theme_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this296.get("/themes/".concat(theme_id), {
        fields
      }, null, options);
    })();
  }
  ...
  update_theme(theme_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      theme_id = encodeParam(theme_id);
      return _this297.patch("/themes/".concat(theme_id), null, body, options);
    })();
  }
  ...
  delete_theme(theme_id, options) {
    ...
    return _asyncToGenerator(function* () {
      theme_id = encodeParam(theme_id);
      return _this298.delete("/themes/".concat(theme_id), null, null, options);
    })();
  }
  ...
  search_users(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this302.get('/users/search', {
        fields: request.fields,
        page: request.page,
        per_page: request.per_page,
        sorts: request.sorts,
  ...
  search_users_names(request, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this303.get("/users/search/names/".concat(request.pattern), {
        fields: request.fields,
        page: request.page,
        per_page: request.per_page,
        sorts: request.sorts,
  ...
  user(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this304.get("/users/".concat(user_id), {
        fields
      }, null, options);
    })();
  }
  ...
  update_user(user_id, body, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this305.patch("/users/".concat(user_id), {
        fields
      }, body, options);
    })();
  }
  ...
  delete_user(user_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this306.delete("/users/".concat(user_id), null, null, options);
    })();
  }
  ...
  user_for_credential(credential_type, credential_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      credential_id = encodeParam(credential_id);
      return _this307.get("/users/credential/".concat(credential_type, "/").concat(credential_id), {
        fields
      }, null, options);
    })();
  }
  ...
  user_credentials_email(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this308.get("/users/".concat(user_id, "/credentials_email"), {
        fields
      }, null, options);
    })();
  }
  ...
  create_user_credentials_email(user_id, body, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this309.post("/users/".concat(user_id, "/credentials_email"), {
        fields
      }, body, options);
    })();
  }
  ...
  update_user_credentials_email(user_id, body, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this310.patch("/users/".concat(user_id, "/credentials_email"), {
        fields
      }, body, options);
    })();
  }
  ...
  delete_user_credentials_email(user_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this311.delete("/users/".concat(user_id, "/credentials_email"), null, null, options);
    })();
  }
  ...
  user_credentials_totp(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this312.get("/users/".concat(user_id, "/credentials_totp"), {
        fields
      }, null, options);
    })();
  }
  ...
  create_user_credentials_totp(user_id, body, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this313.post("/users/".concat(user_id, "/credentials_totp"), {
        fields
      }, body, options);
    })();
  }
  ...
  delete_user_credentials_totp(user_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this314.delete("/users/".concat(user_id, "/credentials_totp"), null, null, options);
    })();
  }
  ...
  user_credentials_ldap(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this315.get("/users/".concat(user_id, "/credentials_ldap"), {
        fields
      }, null, options);
    })();
  }
  ...
  delete_user_credentials_ldap(user_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this316.delete("/users/".concat(user_id, "/credentials_ldap"), null, null, options);
    })();
  }
  ...
  user_credentials_google(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this317.get("/users/".concat(user_id, "/credentials_google"), {
        fields
      }, null, options);
    })();
  }
  ...
  delete_user_credentials_google(user_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this318.delete("/users/".concat(user_id, "/credentials_google"), null, null, options);
    })();
  }
  ...
  user_credentials_saml(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this319.get("/users/".concat(user_id, "/credentials_saml"), {
        fields
      }, null, options);
    })();
  }
  ...
  delete_user_credentials_saml(user_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this320.delete("/users/".concat(user_id, "/credentials_saml"), null, null, options);
    })();
  }
  ...
  user_credentials_oidc(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this321.get("/users/".concat(user_id, "/credentials_oidc"), {
        fields
      }, null, options);
    })();
  }
  ...
  delete_user_credentials_oidc(user_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this322.delete("/users/".concat(user_id, "/credentials_oidc"), null, null, options);
    })();
  }
  ...
  user_credentials_api3(user_id, credentials_api3_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this323.get("/users/".concat(user_id, "/credentials_api3/").concat(credentials_api3_id), {
        fields
      }, null, options);
    })();
  }
  ...
  delete_user_credentials_api3(user_id, credentials_api3_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this324.delete("/users/".concat(user_id, "/credentials_api3/").concat(credentials_api3_id), null, null, options);
    })();
  }
  ...
  all_user_credentials_api3s(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this325.get("/users/".concat(user_id, "/credentials_api3"), {
        fields
      }, null, options);
    })();
  }
  ...
  create_user_credentials_api3(user_id, body, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this326.post("/users/".concat(user_id, "/credentials_api3"), {
        fields
      }, body, options);
    })();
  }
  ...
  user_credentials_embed(user_id, credentials_embed_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this327.get("/users/".concat(user_id, "/credentials_embed/").concat(credentials_embed_id), {
        fields
      }, null, options);
    })();
  }
  ...
  delete_user_credentials_embed(user_id, credentials_embed_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this328.delete("/users/".concat(user_id, "/credentials_embed/").concat(credentials_embed_id), null, null, options);
    })();
  }
  ...
  all_user_credentials_embeds(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this329.get("/users/".concat(user_id, "/credentials_embed"), {
        fields
      }, null, options);
    })();
  }
  ...
  user_credentials_looker_openid(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this330.get("/users/".concat(user_id, "/credentials_looker_openid"), {
        fields
      }, null, options);
    })();
  }
  ...
  delete_user_credentials_looker_openid(user_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this331.delete("/users/".concat(user_id, "/credentials_looker_openid"), null, null, options);
    })();
  }
  ...
  user_session(user_id, session_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this332.get("/users/".concat(user_id, "/sessions/").concat(session_id), {
        fields
      }, null, options);
    })();
  }
  ...
  delete_user_session(user_id, session_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this333.delete("/users/".concat(user_id, "/sessions/").concat(session_id), null, null, options);
    })();
  }
  ...
  all_user_sessions(user_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this334.get("/users/".concat(user_id, "/sessions"), {
        fields
      }, null, options);
    })();
  }
  ...
  create_user_credentials_email_password_reset(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this335.post("/users/".concat(request.user_id, "/credentials_email/password_reset"), {
  ...
  user_roles(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this336.get("/users/".concat(request.user_id, "/roles"), {
        fields: request.fields,
        direct_association_only: request.direct_association_only
      }, null, options);
    })();
  ...
  set_user_roles(user_id, body, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this337.put("/users/".concat(user_id, "/roles"), {
        fields
      }, body, options);
    })();
  }
  ...
  user_attribute_user_values(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this338.get("/users/".concat(request.user_id, "/attribute_values"), {
        fields: request.fields,
  ...
  set_user_attribute_user_value(user_id, user_attribute_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this339.patch("/users/".concat(user_id, "/attribute_values/").concat(user_attribute_id), null, body, options);
    })();
  }
  ...
  delete_user_attribute_user_value(user_id, user_attribute_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this340.delete("/users/".concat(user_id, "/attribute_values/").concat(user_attribute_id), null, null, options);
    })();
  }
  ...
  all_user_attributes(request, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this341.get('/user_attributes', {
        fields: request.fields,
        sorts: request.sorts
      }, null, options);
    })();
  ...
  create_user_attribute(body, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this342.post('/user_attributes', {
        fields
      }, body, options);
    })();
  }
  ...
  user_attribute(user_attribute_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this343.get("/user_attributes/".concat(user_attribute_id), {
        fields
      }, null, options);
    })();
  }
  ...
  update_user_attribute(user_attribute_id, body, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this344.patch("/user_attributes/".concat(user_attribute_id), {
        fields
      }, body, options);
    })();
  }
  ...
  delete_user_attribute(user_attribute_id, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this345.delete("/user_attributes/".concat(user_attribute_id), null, null, options);
    })();
  }
  ...
  all_user_attribute_group_values(user_attribute_id, fields, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this346.get("/user_attributes/".concat(user_attribute_id, "/group_values"), {
        fields
      }, null, options);
    })();
  }
  ...
  set_user_attribute_group_values(user_attribute_id, body, options) {
    ...
    return _asyncToGenerator(function* () {
      return _this347.post("/user_attributes/".concat(user_attribute_id, "/group_values"), null, body, options);
    })();
  }
  ...
  all_workspaces(options) {
    ...
    return _asyncToGenerator(function* () {
      return _this348.get('/workspaces', null, null, options);
    })();
  }
  ...
  workspace(workspace_id, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return _this349.get("/workspaces/".concat(workspace_id), null, null, options);
    })();
  }
