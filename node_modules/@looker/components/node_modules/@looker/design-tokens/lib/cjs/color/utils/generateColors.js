...
var _generateColorAliases = require("./generateColorAliases");
...
const generateColors = (themeColors, customColors) => {
  ...
  const derivatives = (0, _generateDerivativeColors.generateDerivativeColors)(specifiable);
  const statefulColors = (0, _generateStatefulColors.generateStatefulColors)(specifiable, derivatives);
  const aliases = (0, _generateColorAliases.generateColorAliases)(blends);
  return _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, specifiable), derivatives), blends), statefulColors), aliases);
};
