...
export var sanitizeFontFamily = function sanitizeFontFamily(faces) {
  return sanitizeFontFamilyArray(faces).join(', ');
};
export var sanitizeFontFamilyArray = function sanitizeFontFamilyArray(faces) {
  return faces.split(',').map(function (face) {
    return sanitizeFontFace(face);
  });
};
export var sanitizeFontFace = function sanitizeFontFace(face) {
