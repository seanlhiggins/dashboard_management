...
export var generateFontFamilies = function generateFontFamilies(defaultFonts, fallbacks, customFonts) {
  var fontFamilies = _objectSpread(_objectSpread({}, defaultFonts), pickBy(customFonts, identity));
