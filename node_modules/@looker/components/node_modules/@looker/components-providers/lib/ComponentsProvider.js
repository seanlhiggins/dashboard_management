...
import { generateTheme, GlobalStyle, IEGlobalStyle, googleFontUrl, theme as defaultTheme } from '@looker/design-tokens';
...
export var ComponentsProvider = function ComponentsProvider(_ref) {
  var children = _ref.children,
      _ref$globalStyle = _ref.globalStyle,
      globalStyle = _ref$globalStyle === void 0 ? true : _ref$globalStyle,
      _ref$ie11Support = _ref.ie11Support,
      ie11Support = _ref$ie11Support === void 0 ? false : _ref$ie11Support,
      ...
      props = _objectWithoutProperties(_ref, ["children", "globalStyle", "ie11Support", "loadFontSources", "loadGoogleFonts", "locale", "resources", "themeCustomizations"]);
  ...
  return React.createElement(HelmetProvider, null, React.createElement(ThemeProvider, _extends({}, props, {
    theme: theme
  }), globalStyle && React.createElement(GlobalStyle, null), loadFontSources && React.createElement(FontFaceLoader, null), ie11Support && React.createElement(IEGlobalStyle, null), React.createElement(FocusTrapProvider, null, React.createElement(ScrollLockProvider, null, children))));
};
