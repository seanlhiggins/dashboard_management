...
const MessageBarLayout = (0, _react.forwardRef)((_ref, ref) => {
  let id = _ref.id,
      ...
      props = _objectWithoutProperties(_ref, ["id", "children", "intent", "visible", "onPrimaryClick", "onSecondaryClick", "primaryAction", "secondaryAction", "noActions"]);
...
const backgroundColor = (0, _styledSystem.variant)({
  prop: 'intent',
  variants: {
    critical: {
