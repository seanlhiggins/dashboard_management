...
exports.AccordionContext = exports.accordionContextDefaults = void 0;
...
const accordionContextDefaults = {
  accordionContentId: '',
  ...
  indicatorSize: 'small',
  isOpen: false,
  toggleOpen: _ => undefined
};
exports.accordionContextDefaults = accordionContextDefaults;
const AccordionContext = (0, _react.createContext)(_objectSpread({}, accordionContextDefaults));
