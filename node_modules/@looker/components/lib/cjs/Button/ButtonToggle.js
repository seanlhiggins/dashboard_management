...
const ButtSetAsToggle = _ButtonSet.ButtonSet;
const ButtonToggleLayout = (0, _react.forwardRef)((_ref, ref) => {
  let nullable = _ref.nullable,
...
const ButtonToggle = (0, _styledComponents.default)(ButtonToggleLayout).withConfig({
  ...
  theme
}) => theme.colors.background, _height.inputHeight, ({
  theme
}) => theme.colors.ui2, _height.inputHeight, ({
  theme
}) => theme.colors.ui2, _height.inputHeight, ({
  theme
}) => theme.colors.ui2, _height.inputHeight, _ButtonItem.ButtonItem, ({
  theme
}) => theme.colors.ui2);
