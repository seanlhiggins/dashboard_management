...
const MultiFunctionButton = (0, _react.forwardRef)(({
  alternate,
  children,
  alternateRef,
  swap = false
  ...
  const bRef = (0, _react.useRef)(null);
  (0, _react.useEffect)(() => {
  ...
  return _react.default.createElement(MultiFunctionButtonLayout, {
    swap: swap,
...
const MultiFunctionButtonLayout = _styledComponents.default.div.withConfig({
  displayName: "MultiFunctionButton__MultiFunctionButtonLayout",
  componentId: "uf1rdu-0"
})(["align-items:center;display:flex;height:", "px;justify-content:center;width:", "px;", ""], ({
  height
}) => height, ({
  width
}) => width, ({
