...
const Menu = (0, _react.forwardRef)((_ref, ref) => {
  ...
  const _partitionMenuProps = partitionMenuProps(restProps, _Popover.popoverPropKeys),
  ...
  const list = content && _react.default.createElement(_MenuList.MenuList, _extends({
    id: id
  }, listProps, {
    ref: listRef,
    "data-autofocus": "true"
