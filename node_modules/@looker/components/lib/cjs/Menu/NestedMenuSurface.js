...
const NestedMenuSurface = (0, _styledComponents.default)(_OverlaySurface.OverlaySurface).withConfig({
  displayName: "NestedMenuSurface",
  componentId: "sc-5ytfs8-0"
})(["&[data-placement]{padding:0;}", "{box-shadow:", ";}"], _OverlaySurface.OverlaySurfaceContentArea, ({
  theme
}) => theme.shadows[1]);
