...
const FieldCheckboxGroupLayout = (_ref) => {
  let propsID = _ref.id,
      ...
      props = _objectWithoutProperties(_ref, ["id", "options", "value", "name", "inputsInline"]);
...
const FieldCheckboxGroup = (0, _styledComponents.default)(FieldCheckboxGroupLayout).withConfig({
  displayName: "FieldCheckboxGroup",
  componentId: "w2hs65-0"
})([""]);
