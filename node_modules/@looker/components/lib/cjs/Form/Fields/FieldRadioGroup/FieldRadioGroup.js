...
const FieldRadioGroupLayout = (_ref) => {
  let propsID = _ref.id,
      ...
      props = _objectWithoutProperties(_ref, ["id", "options", "name", "inputsInline"]);
  ...
  return _react.default.createElement(_Field.Field, _extends({}, (0, _Field.pickFieldProps)(props), {
    id: id
  }), _react.default.createElement(_OptionsGroup.RadioGroup, _extends({}, (0, _Field.omitFieldProps)(props), {
...
const FieldRadioGroup = (0, _styledComponents.default)(FieldRadioGroupLayout).withConfig({
