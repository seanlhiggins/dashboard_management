...
const FieldTimeComponent = (0, _react.forwardRef)((props, ref) => {
  ...
  }), _react.default.createElement(_InputTime.InputTime, _extends({}, (0, _Field.omitFieldProps)(props), {
...
const FieldTime = (0, _styledComponents.default)(FieldTimeComponent).withConfig({
