...
const FieldCheckboxLayout = (0, _react.forwardRef)((props, ref) => {
  const validationMessage = (0, _Form.useFormContext)(props);
  const id = (0, _utils.useID)(props.id);
  return _react.default.createElement(_FieldInline.FieldInline, _extends({}, (0, _Field.pickFieldProps)(props), {
...
const FieldCheckbox = (0, _styledComponents.default)(FieldCheckboxLayout).withConfig({
  displayName: "FieldCheckbox",
  componentId: "xffymf-0"
})([""]);
