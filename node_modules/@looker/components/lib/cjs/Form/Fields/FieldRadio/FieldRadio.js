...
const FieldRadioLayout = (0, _react.forwardRef)((props, ref) => {
  const validationMessage = (0, _Form.useFormContext)(props);
  const id = (0, _utils.useID)(props.id);
  return _react.default.createElement(_FieldInline.FieldInline, _extends({
    id: id,
...
const FieldRadio = (0, _styledComponents.default)(FieldRadioLayout).withConfig({
