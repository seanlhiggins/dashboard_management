...
const InputFiltersLayout = ({
  ...
  const assignedFilters = filters.filter(filter => filter.value || filter.field === fieldEditing).sort((a, b) => a.value === undefined ? 1 : b.value === undefined ? -1 : 0);
...
const ChipWrapper = _styledComponents.default.div.withConfig({
  ...
  theme
}) => theme.space.xxsmall, _Chip.Chip);
...
})(["align-items:start;border:solid 1px ", ";border-radius:", ";display:flex;flex-wrap:wrap;padding:", " 0;padding-left:", ";width:100%;", "{margin-left:", ";}", " ", "{display:none;}", "{border:none;height:30px;padding:0;&:focus-within{box-shadow:none;}input{padding:0;}}"], ({
  theme
}) => theme.colors.ui2, ({
  theme: {
    radii
...
}) => space.xsmall, _Select.Select, ({
  theme: {
    space
  }
}) => space.xxsmall, _Select.Select, _Icon.Icon, _InputText.InputText);
