...
const InputSearchLayout = (0, _react.forwardRef)((_ref, ref) => {
  let autoResize = _ref.autoResize,
      ...
      props = _objectWithoutProperties(_ref, ["autoResize", "autoFocus", "changeOnSelect", "clearOnClose", "defaultValue", "disabled", "hideSearchIcon", "clearIconLabel", "indicator", "isClearable", "isLoading", "listLayout", "name", "noOptionsLabel", "onChange", "onSelectOption", "options", "placeholder", "readOnly", "summary", "value", "windowedOptions"]);
  ...
  const matchingOption = (0, _options.getMatchingOption)(valueToUse, navigationOptions);
...
const InputSearch = (0, _styledComponents.default)(InputSearchLayout).withConfig({
  displayName: "InputSearch",
  componentId: "c2e1s0-0"
})([""]);
