...
function validateValues(newValues, currentValues, validate) {
...
const InputChipsInternal = (0, _react.forwardRef)((_ref, ref) => {
  ...
  function updateValues(newInputValue) {
    ...
    const _validateValues = validateValues(inputValues, values, validate),
...
const InputChips = (0, _styledComponents.default)(InputChipsInternal).withConfig({
