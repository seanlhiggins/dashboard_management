...
const InternalRangeSlider = (0, _react.forwardRef)(({
  ...
  const _useState = (0, _react.useState)(sort(boundedValue)),
  ...
  const handleMouseDown = (0, _partial.default)(handleMouseEvent, false);
  const handleMouseDrag = (0, _partial.default)(handleMouseEvent, true);
  (0, _react.useEffect)(() => {
    if (isMouseDown) {
      refreshDomRect();
    }
