...
var _ListItemPreface = require("../../../List/ListItemPreface");
...
const OptionLayoutBase = ({
  ...
  const description = option.description,
        ...
        rest = _objectWithoutProperties(option, ["description", "detail", "preface"]);
  ...
  if (description || detail || preface) {
    return _react.default.createElement(Component, _extends({}, rest, {
      ...
      preface: preface
    }, rest)), detail && _react.default.createElement(_ListItemDetail.ListItemDetail, null, detail));
  }
...
const OptionLayout = (_ref) => {
  let option = _ref.option,
      rest = _objectWithoutProperties(_ref, ["option"]);
...
const SelectOptions = props => {
  ...
  const flatOptions = props.flatOptions,
        ...
        windowedOptions = props.windowedOptions,
        isLoading = props.isLoading;

  const _useWindowedOptions = (0, _useWindowedOptions2.useWindowedOptions)(windowedOptions, flatOptions, navigationOptions, isMulti),
...
const SelectCreateOption = ({
  ...
  const shouldShow = (0, _react.useMemo)(() => {
    const currentOptions = isMulti ? dataMulti.options : data.option ? [data.option] : [];
...
const EmptyListItem = _styledComponents.default.li.withConfig({
  ...
  theme
}) => `${theme.space.xlarge} ${theme.space.medium}`);
