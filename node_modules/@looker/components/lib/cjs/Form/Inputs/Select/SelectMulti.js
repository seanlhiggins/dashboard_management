...
const SelectMultiComponent = (0, _react.forwardRef)((_ref, ref) => {
  ...
  const optionValues = (0, _options.getOptions)(values, navigationOptions);
  const defaultOptionValues = (0, _options.getOptions)(defaultValues, navigationOptions);
...
const SelectMulti = (0, _styledComponents.default)(SelectMultiComponent).withConfig({
