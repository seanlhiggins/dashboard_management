...
var _ariaProps = require("./utils/ariaProps");
...
const SelectComponent = (0, _react.forwardRef)((_ref, ref) => {
  let options = _ref.options,
      ...
      windowedOptionsProp = _ref.windowedOptions,
      ...
      props = _objectWithoutProperties(_ref, ["options", "disabled", "autoFocus", "isFilterable", "isClearable", "placeholder", "name", "onFilter", "onChange", "value", "defaultValue", "noOptionsLabel", "indicator", "listLayout", "autoResize", "windowedOptions", "showCreate", "formatCreateLabel", "isLoading"]);

  const _useFlatOptions = (0, _useFlatOptions2.useFlatOptions)(options),
        flatOptions = _useFlatOptions.flatOptions,
        navigationOptions = _useFlatOptions.navigationOptions;

  const optionValue = (0, _options.getOption)(value, navigationOptions);
  const nullDefault = (isClearable || placeholder) && !defaultValue;
  const defaultOptionValue = nullDefault ? undefined : (0, _options.getOption)(defaultValue, navigationOptions) || options && (0, _options.getFirstOption)(options);
  ...
  const windowedOptions = (0, _useWindowedOptions.useShouldWindowOptions)(flatOptions, windowedOptionsProp);
...
const Select = (0, _styledComponents.default)(SelectComponent).withConfig({
  displayName: "Select",
