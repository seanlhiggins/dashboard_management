...
function pickAriaAndValidationProps(_ref) {
  let validationType = _ref.validationType,
      props = _objectWithoutProperties(_ref, ["validationType"]);

  const ariaProps = (0, _pick.default)(props, ariaKeys);
...
function omitAriaAndValidationProps(props) {
  return (0, _omit.default)(props, [...ariaKeys, 'validationType']);
}
