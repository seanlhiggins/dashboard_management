...
const ComboboxMultiOptionInternal = (0, _react.forwardRef)((_ref, forwardedRef) => {
  let children = _ref.children,
      ...
      props = _objectWithoutProperties(_ref, ["children", "indicator", "highlightText", "scrollIntoView"]);
  ...
  return _react.default.createElement(_ComboboxOption.ComboboxOptionWrapper, _extends({}, props, optionEvents, {
    ...
    checked: isSelected,
    mt: "xxxsmall"
  })), children || _react.default.createElement(_ComboboxOption.ComboboxOptionText, {
    highlightText: highlightText
  }));
});
ComboboxMultiOptionInternal.displayName = 'ComboboxMultiOptionInternal';
const ComboboxMultiOption = (0, _styledComponents.default)(ComboboxMultiOptionInternal).attrs(({
  color = 'text4',
  display = 'flex',
  fontSize = 'small',
  lineHeight = 'small',
  ...
  componentId: "t8w536-0"
})(["", ""], _ComboboxOption.comboboxOptionStyle);
