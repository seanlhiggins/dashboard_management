...
})(["", " ", " ", " list-style-type:none;margin:0;max-height:30rem;outline:none;position:relative;", " ", ""], _designTokens.reset, _designTokens.typography, _designTokens.space, _designTokens.layout, ({
  isMulti
}) => (0, _utils.listPadding)(isMulti ? _ComboboxMultiOption.ComboboxMultiOption : _ComboboxOption.ComboboxOption));
