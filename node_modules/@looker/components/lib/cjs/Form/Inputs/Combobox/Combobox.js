...
const ComboboxInternal = (0, _react.forwardRef)((_ref, forwardedRef) => {
  let _ref$openOnFocus = _ref.openOnFocus,
      ...
      onOpen = _ref.onOpen,
      propsID = _ref.id,
      rest = _objectWithoutProperties(_ref, ["openOnFocus", "openOnClick", "onChange", "value", "defaultValue", "onClose", "onOpen", "id"]);
  ...
  const _useReducerMachine = (0, _state.useReducerMachine)(_state.reducer, _objectSpread(_objectSpread({}, _ComboboxContext.defaultData), initialData), {}),
  ...
  const isVisible = (0, _useComboboxToggle.useComboboxToggle)(state, option, onOpen, onClose);
...
const ComboboxWrapper = (0, _react.forwardRef)((_ref2, ref) => {
  let isVisible = _ref2.isVisible,
...
const Combobox = (0, _styledComponents.default)(ComboboxInternal).attrs(({
  display = 'flex'
}) => ({
  display
})).withConfig({
