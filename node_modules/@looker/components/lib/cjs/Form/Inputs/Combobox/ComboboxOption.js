...
const ComboboxOptionWrapperInternal = (0, _react.forwardRef)((_ref, forwardedRef) => {
  let children = _ref.children,
      label = _ref.label,
      value = _ref.value,
      rest = _objectWithoutProperties(_ref, ["children", "label", "value"]);
  ...
  }, _react.default.createElement("li", _extends({}, (0, _omit.default)((0, _designTokens.omitStyledProps)(rest), 'isSelected'), {
    ref: forwardedRef,
...
const ComboboxOptionWrapper = (0, _styledComponents.default)(ComboboxOptionWrapperInternal).withConfig({
  displayName: "ComboboxOption__ComboboxOptionWrapper",
  componentId: "w994y4-0"
})(["background-color:", ";&[aria-selected='true']{background-color:", ";}"], ({
  isSelected,
  theme
...
const ComboboxOptionInternal = (0, _react.forwardRef)((_ref2, forwardedRef) => {
  let children = _ref2.children,
      ...
      props = _objectWithoutProperties(_ref2, ["children", "indicator", "highlightText", "scrollIntoView"]);
...
const ComboboxOption = (0, _styledComponents.default)(ComboboxOptionInternal).attrs(({
  ...
  componentId: "w994y4-1"
})(["", ""], comboboxOptionStyle);
exports.ComboboxOption = ComboboxOption;

function ComboboxOptionTextInternal(_ref3) {
  let _ref3$highlightText = _ref3.highlightText,
      highlightText = _ref3$highlightText === void 0 ? true : _ref3$highlightText,
      props = _objectWithoutProperties(_ref3, ["highlightText"]);
