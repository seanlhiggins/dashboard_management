...
const InlineTextAreaLayout = (0, _react.forwardRef)((_ref, ref) => {
  ...
  const _useState = (0, _react.useState)(valueProp),
...
})(["background:transparent;border:none;caret-color:", ";color:transparent;cursor:", ";font:inherit;height:100%;left:0;outline:none;padding:0;position:absolute;resize:none;text-align:inherit;text-transform:inherit;top:0;width:100%;"], ({
  theme
}) => theme.colors.text5, ({
  readOnly,
  disabled
...
const VisibleText = _styledComponents.default.div.withConfig({
...
const InlineTextArea = (0, _styledComponents.default)(InlineTextAreaLayout).withConfig({
  displayName: "InlineTextArea",
  componentId: "sc-1ioqw6m-2"
})(["", " border:none;border-bottom:1px dashed;border-bottom-color:", ";color:", ";display:inline-flex;flex-direction:column;justify-content:center;min-height:", ";min-width:2rem;position:relative;text-align:inherit;white-space:pre-wrap;:focus,:hover{background-color:", ";border-bottom-color:", ";outline:none;}:focus{border-bottom-style:solid;}:disabled,:hover{border-bottom-color:", ";}:hover{border-bottom-color:", ";}"], _designTokens.typography, ({
  theme,
  ...
  disabled,
  theme
}) => disabled ? theme.colors.text1 : 'inherit', props => props.theme.lineHeights.medium, props => props.theme.colors.ui1, props => props.theme.colors.key, ({
  theme
}) => theme.colors.text1, ({
  readOnly
