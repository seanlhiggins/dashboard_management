...
exports.Popover = exports.popoverPropKeys = void 0;
...
const popoverPropKeys = ['content', 'onClose', 'placement', 'portalElement', 'pin', 'disableScrollLock', 'triggerElement', 'focusTrap', 'scrollLock', 'surface', 'disabled', 'isOpen', 'canClose', 'setOpen', 'triggerToggle', 'cancelClickOutside', 'hoverDisclosureRef'];
exports.popoverPropKeys = popoverPropKeys;
const Popover = (0, _react.forwardRef)((_ref, forwardedRef) => {
  let children = _ref.children,
      hoverDisclosureRef = _ref.hoverDisclosureRef,
      props = _objectWithoutProperties(_ref, ["children", "hoverDisclosureRef"]);

  const _usePopover = (0, _usePopover2.usePopover)(props),
  ...
  const onClick = domProps.onClick,
        ...
        restDomProps = _objectWithoutProperties(domProps, ["onClick", "ref"]);

  const ref = (0, _utils.useForkedRef)(popoverRef, forwardedRef);
  ...
  const _useHovered = (0, _utils.useHovered)(hoverDisclosureRef),
        _useHovered2 = _slicedToArray(_useHovered, 1),
