...
function useConfirm(props) {
  const _useToggle = (0, _useToggle2.useToggle)(),
        value = _useToggle.value,
        setOn = _useToggle.setOn,
        setOff = _useToggle.setOff;

  const rendered = _react.default.createElement(_ConfirmationDialog.ConfirmationDialog, _extends({}, props, {
    isOpen: value,
    close: setOff
  }));
...
const Confirm = (_ref) => {
  ...
  const _useConfirm = useConfirm(props),
