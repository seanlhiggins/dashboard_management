...
const ConfirmationDialog = props => {
  const _useTranslation = (0, _reactI18next.useTranslation)('ConfirmationDialog'),
        t = _useTranslation.t;

  const _props$cancelLabel = props.cancelLabel,
        ...
        title = props.title,
        rest = _objectWithoutProperties(props, ["cancelLabel", "close", "confirmLabel", "buttonColor", "cancelColor", "isOpen", "message", "onCancel", "onConfirm", "title"]);

  const confirm = (0, _react.useCallback)(() => {
    onConfirm(close);
  }, [close, onConfirm]);
