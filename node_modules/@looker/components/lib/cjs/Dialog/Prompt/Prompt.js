...
function usePrompt(props) {
  const _useToggle = (0, _utils.useToggle)(),
        value = _useToggle.value,
        setOn = _useToggle.setOn,
        setOff = _useToggle.setOff;

  const rendered = _react.default.createElement(_PromptDialog.PromptDialog, _extends({}, props, {
    isOpen: value,
    close: setOff
  }));
...
const Prompt = (_ref) => {
  ...
  const _usePrompt = usePrompt(props),
        _usePrompt2 = _slicedToArray(_usePrompt, 2),
