...
const DialogFooterLayout = (_ref) => {
  let children = _ref.children,
      secondary = _ref.secondary,
      props = _objectWithoutProperties(_ref, ["children", "secondary"]);
...
const DialogFooter = (0, _styledComponents.default)(DialogFooterLayout).attrs(({
  px = 'xlarge',
  py = 'large'
}) => ({
  px,
