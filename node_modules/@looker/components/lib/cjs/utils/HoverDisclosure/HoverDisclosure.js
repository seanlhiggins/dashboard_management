...
const HoverDisclosure = ({
  ...
  const context = (0, _react.useContext)(_HoverDisclosureContext.HoverDisclosureContext);
  return visible || context.visible ? _react.default.createElement(_react.default.Fragment, null, children) : null;
};
