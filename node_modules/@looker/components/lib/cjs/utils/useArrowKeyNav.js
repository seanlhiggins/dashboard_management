...
const useArrowKeyNav = ({
  ...
  const focusedItemRef = (0, _react.useRef)();
  ...
  const handleArrowKey = (e, direction, vertical) => {
    if (internalRef.current) {
      const newFocusedItem = getNextFocus(direction, internalRef.current, vertical);
  ...
  const placeInitialFocus = (0, _react.useCallback)(() => {
    if (internalRef.current) {
