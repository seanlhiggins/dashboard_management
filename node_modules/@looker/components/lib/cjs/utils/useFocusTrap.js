...
const useFocusTrap = (_ref) => {
  let clickOutsideDeactivates = _ref.clickOutsideDeactivates,
      props = _objectWithoutProperties(_ref, ["clickOutsideDeactivates"]);

  const returnFocusRef = (0, _react.useRef)(null);
