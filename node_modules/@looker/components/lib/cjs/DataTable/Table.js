...
const selectColumn = (0, _styledComponents.css)(["", ""], ({
  ...
  theme
}) => theme.space.xsmall) : (0, _styledComponents.css)(["&:first-child{max-width:0;min-width:0;}"]));
...
}) => `${space.xsmall}  ${space.medium}`, selectColumn, actionsColumn, ({
  theme
