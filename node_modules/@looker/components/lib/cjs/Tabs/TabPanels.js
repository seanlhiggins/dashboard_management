...
const Layout = (_ref) => {
  let children = _ref.children,
      ...
      props = _objectWithoutProperties(_ref, ["children", "className", "selectedIndex"]);

  const tabPanelsLayoutProps = (0, _omit.default)(props, 'onSelectTab');
...
const TabPanels = (0, _styledComponents.default)(Layout).attrs(({
  pt = 'large'
}) => ({
  pt
})).withConfig({
