...
const DeterminateContainer = _styledComponents.default.div.withConfig({
...
const DeterminateCircle = _styledComponents.default.circle.withConfig({
  displayName: "DeterminateProgress__DeterminateCircle",
  componentId: "yb0ja2-1"
})(["stroke:", ";transition:stroke-dashoffset 500ms;"], props => props.theme.colors.key);
