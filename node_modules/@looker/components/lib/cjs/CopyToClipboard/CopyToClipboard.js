...
const CopyToClipboard = props => {
  const _useTranslation = (0, _reactI18next.useTranslation)('CopyToClipboard'),
        t = _useTranslation.t;
  ...
  const copyButton = typeof children === 'string' ? _react.default.createElement(_ButtonOutline.ButtonOutline, {
  ...
  const successButton = typeof success === 'string' ? _react.default.createElement(_ButtonOutline.ButtonOutline, {
    "aria-live": "polite",
