...
import { UsePopoverProps, UsePopoverResponseDom } from './usePopover';
...
export declare const Popover: React.ForwardRefExoticComponent<PopoverProps & React.RefAttributes<any>>;
