...
export var InternalRangeSlider = forwardRef(function (_ref, ref) {
  ...
  var _useState = useState(sort(boundedValue)),
  ...
  var focusChangedPoint = function focusChangedPoint(newValue, newPoint) {
  ...
  var handleMouseEvent = function handleMouseEvent(maintainFocus) {
    if (!disabled && !readOnly) {
  ...
  var handleMouseDown = partial(handleMouseEvent, false);
  var handleMouseDrag = partial(handleMouseEvent, true);
  useEffect(function () {
    if (isMouseDown) {
      refreshDomRect();
    }
