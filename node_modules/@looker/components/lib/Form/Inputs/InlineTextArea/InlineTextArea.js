...
export var InlineTextAreaLayout = forwardRef(function (_ref, ref) {
...
})(["background:transparent;border:none;caret-color:", ";color:transparent;cursor:", ";font:inherit;height:100%;left:0;outline:none;padding:0;position:absolute;resize:none;text-align:inherit;text-transform:inherit;top:0;width:100%;"], function (_ref2) {
...
var VisibleText = styled.div.withConfig({
...
export var InlineTextArea = styled(InlineTextAreaLayout).withConfig({
  ...
  return props.theme.lineHeights.medium;
}, function (props) {
