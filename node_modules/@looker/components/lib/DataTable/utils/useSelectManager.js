...
export var useSelectManager = function useSelectManager(possibilities) {
  var defaultSelections = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

  var _useState = useState(defaultSelections),
  ...
  var onSelect = function onSelect(selectionId) {
    setSelections(selections.includes(selectionId) ? selections.filter(function (itemId) {
      return itemId !== selectionId && possibilities.includes(itemId);
    }) : [].concat(_toConsumableArray(selections), [selectionId]));
  };
