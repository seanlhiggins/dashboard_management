...
export var iconButtonIconSizeMap = {
  xxsmall: 'xxsmall',
  xsmall: 'xsmall',
  small: 'small',
  medium: 'small',
...
export var buttonPadding = function buttonPadding(hasIcon, size) {
  switch (size) {
    case 'xxsmall':
      return 'xsmall';
