...
export var CopyToClipboard = function CopyToClipboard(props) {
  var _useTranslation = useTranslation('CopyToClipboard'),
      t = _useTranslation.t;
  ...
  var copyButton = typeof children === 'string' ? React.createElement(ButtonOutline, {
  ...
  var successButton = typeof success === 'string' ? React.createElement(ButtonOutline, {
    "aria-live": "polite",
