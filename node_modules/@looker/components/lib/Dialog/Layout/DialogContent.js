...
import { padding, reset, layout, pickStyledProps } from '@looker/design-tokens';
...
export var DialogContent = function DialogContent(_ref) {
  ...
  return React.createElement(InnerDialogContent, _extends({
...
var InnerDialogContent = styled.div.withConfig({
  displayName: "DialogContent__InnerDialogContent",
  componentId: "rfzesr-0"
})(["", " ", " ", " flex:1 1 auto;overflow:auto;", ""], reset, layout, padding, function (_ref2) {
  var hasOverflow = _ref2.hasOverflow,
      theme = _ref2.theme;
  return hasOverflow && css(["border-bottom:1px solid ", ";border-top:1px solid ", ";box-shadow:inset 0 -4px 4px -4px ", ";"], theme.colors.ui2, theme.colors.ui2, theme.colors.ui2);
});
